<div>
    <div style="background-color: #f2f2f2;padding: 15px;border-radius: 15px">
        <div style="background-color: #424242;padding: 15px;color: whitesmoke">
            <h3 class="text-center p3"><b><span class="fas fa-cash-register" style="color: teal;font-size: 30px"></span>
                    Modulo de recargas</b>
            </h3>
        </div>
        <br>
